...
def multipy(a, b):
    #function to simple matrix multiplication in python 
...
tb = open("t_b.txt", "w")   #file to write time taken for multiplying various matrices using simply user defined python function
